import { alphabetical, byAge, greatestToLeast, leastToGreatest, lengthSort } from './array-sort';


test('Sort an array from smallest number to largest', () => {
...
test('Sort an array from largest number to smallest', () => {
  const input = [1, 3, 5, 2, 90, 20]; // arrange
...
test('Sort an array from shortest string to longest', () => {
...
test('Sort an array alphabetically', () => {
  const input = ['dog', 'wolf', 'by', 'family', 'eaten']; // arrange
...
test('Sort the objects in the array by age', () => {
  const input = [
